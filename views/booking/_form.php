    ...
    <div class="mt-10 sm:w-full sm:max-w-lg">
        ...
        <div class="border-b border-gray-900/10 pb-12 space-y-5">
            ...
            <div class="form-group<?= $errorClass ?>">
                ...
                <div id="select-turf" class="select-classic sm:max-w-sm close-on-blur" data-name="user_nid">
            ...
            <?= $form->field($model, 'date')->input('date', ['class' => 'input-classic sm:max-w-sm']) ?>
            
            <div class="flex space-x-5 sm:max-w-md">
                <?= $form->field($model, 'start_time')->input('time', ['class' => 'input-classic']) ?>
                <div class="mt-10"> — </div>
                <?= $form->field($model, 'end_time')->input('time', ['class' => 'input-classic']) ?>
            </div>

        </div>
        
        <div class="form-group flex justify-end">
            <?= Html::a('Cancel', is_null($model->id) ? '/booking' : '/booking/view/' . $model->nid, $options = ['class' => 'btn-muted']) ?>
